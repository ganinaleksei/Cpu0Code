...
-o printf-stdarg.bc
clang -O1 -target mips-unknown-linux-gnu -c ch8_1_5.cpp -emit-llvm -o ch8_1_5.bc
...
printf-stdarg-def.cpu0.o printf-stdarg.cpu0.o ch8_1_5.cpu0.o ch8_3.cpu0.o \
ch8_5.cpu0.o ch9_4.cpu0.o ch_slinker.cpu0.o lib_cpu0.o -o a.out
