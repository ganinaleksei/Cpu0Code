...
StringRef getELFRelocationTypeName(uint32_t Machine, uint32_t Type) {
  ...
  case ELF::EM_CPU0_LE:
    switch (Type) {
      ...
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_CPU0_TLS_DTP_HI16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_CPU0_TLS_DTP_LO16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_CPU0_TLS_GOTTPREL);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_CPU0_TLS_TPREL32);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_CPU0_TLS_TP_HI16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_CPU0_TLS_TP_LO16);
